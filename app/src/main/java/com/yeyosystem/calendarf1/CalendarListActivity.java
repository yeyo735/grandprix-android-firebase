 ...
 * lead to a {@link CalendarDetailActivity} representing
            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mTwoPane) {
                        ...
                        arguments.putString(CalendarDetailFragment.ARG_ITEM_ID, holder.mItem.id);
                        ...
                        intent.putExtra(CalendarDetailFragment.ARG_ITEM_ID, holder.mItem.id);
